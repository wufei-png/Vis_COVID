	...
	Swiper.prototype = {
		init: function() {
			...
			for (let i = 0; i < this.retImgArr.length; i++) {
				li += `<li style="left: ${i * this.moveWidth}px;width: ${this.moveWidth}px" class="swiper-item"><a href="${this.retImgArr[i].url}"><img style="width: 750px;height: 500px;" src="${this.retImgArr[i].imgPath}" alt=""></a></li>`;
			}
			...
			if (this.autoplay) {
				this.timer = setInterval(this.nextSlider.bind(this, 2000), 2000);
			}
